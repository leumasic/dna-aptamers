...
def make_dataset(file_name="variable_length_dataset.csv", targets=DNA_ONE_HOT):
    ...
    y_tensor_train = torch.tensor(y_array_train_norm, dtype=torch.float32)
    ...
    y_tensor_test = torch.tensor(y_array_test_norm, dtype=torch.float32)
...
def train():
    ...
    train_set, validation_set = make_dataset(
        "/c/Users/arazaghi/OneDrive - Ubisoft/Documents/School/IFT6759/dna-aptamers/src/variable_length_dataset(20).csv"
    )
